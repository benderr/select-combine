...
import {createEffect} from '../../common/helpers/createAction';
...
export const setRateSuccess = ({rate, currencyPair}) => createAction(SET_RATE_SUCCESS, {rate, currencyPair});
export const setRateFail = ({error}) => createAction(SET_RATE_FAIL, {error});
export const loadingCurrencyRate = ({loading}) => createAction(LOADING_CURRENCY_RATE, {loading});
export const fetchCurrencyRate = ({currencyPair}) => createEffect(FETCH_CURRENCY_RATE, {currencyPair});